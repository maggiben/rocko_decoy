...
const alert = {
    vpn: {
        ...
        content: (
            <p>If you are trying to access rocko.co using a VPN, please disconnect and try again. VPNs are not supported.</p>
        )
    },
    region: {
        title: (
            <h1 className="text-2xl font-semibold mb-8 text-center">Not Available in Your Region</h1>
        ),
        content: (
            <p>Our service is not available in your region. If you believe this is a mistake, please contact support@rocko.co</p>
        )
    }
}
