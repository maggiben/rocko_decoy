module.exports = {
  CURRENT_APR:
    'This is a variable (or floating) APR and fluctuates in real-time based on borrowing demand.',
  PROJECTED_INTEREST:
    'This is based on the current APR and displayed in USD at 1:1 exchange rate. Your actual interest will likely be different as it is expected the APR will fluctuate during the term of your loan.',
  COLLATERAL_NEEDED:
  ...
  MAX_LTV:
    'This is the highest loan-to-value (LTV) ratio the lending protocol will allow when originating a loan. The loan-to-value ratio is calculated by dividing the USD value of your loan by the USD value of your collateral. For example, a $1m000 loan with $2,000 of ETH as collateral would have a LTV of 50%.',
  LIQUIDATION_THRESHOLD:
    'This is the loan-to-value (LTV) ratio at which your collateral would be liquidated. For example, if the liquidation threshold is 90%, your collateral would be liquidated if the LTV hit or exceeded 90%.',
  LIQUIDATION_PENALTY:
  ...
  MINIMUM_MONTHLY_PAYMENT:
    'Most lending protocols require no monthly minimum payment.',
  PROTOCOL_REWARDS:
