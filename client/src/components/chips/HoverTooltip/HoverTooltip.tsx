...
const HoverTooltip: React.FC<HoverTooltipProps> = ({ text }) => (
  <div className="relative group">
    ...
    {/* tooltip arrow box */}
    <div className="arrow-down absolute bottom-6 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 left-1/2 transform -translate-x-1/2 bg-gray-800 w-4 h-4 rotate-45 -z-1 group-hover:-z-2" />
  </div>
);
