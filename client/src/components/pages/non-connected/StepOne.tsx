      ...
      subDescription: [
        {
          description: (
            <div className="flex items-center lg:gap-x-1">
              ...
              <HoverTooltip className="tool-tip" text="this is tooltip" />
            </div>
          ),
    ...
    <main className="container mx-auto px-4 md:8 py-4 sm:py-6 lg:py-10">
          ...
          <div className="divide-y-2">
            {invoice.map((info, i) => (
              <React.Fragment key={i}>
                <div className="flex py-4 flex-wrap items-start space-y-2">
                  <p className="font-medium w-[62%] md:w-1/2 text-blackPrimary">
                    {info?.description}
                  </p>
                  <div className="w-[38%] md:w-1/2 text-right md:text-left !mt-0">
                    <div className="flex gap-1 justify-end md:justify-start">
                      ...
                      <p className="text-blackPrimary text-[16px] font-normal	">
                        {info?.details}
                      </p>
                    </div>
                    {info?.subDetails && (
                  ...
                  {info?.subDescription &&
                    info?.subDescription.map((innerInfo, i) => (
                      <React.Fragment key={i}>
                        ...
                        <div className="pt-1 md:pt-0 w-[35%] md:w-1/2 text-right md:text-left !mt-0">
                          <p className="text-blackPrimary font-normal text-[14px] mt-[8px]">
                            {innerInfo?.details}
                          </p>
            ...
            <div className="md:flex justify-between mb-7">
              <div className="flex md:items-center">
                ...
                <label htmlFor="wallet1" className="pl-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Easiest for converting USDC into USD
                  </p>
                </label>
              </div>
              <div className="text-center md:text-left mt-1 lg:mt-0">
                <button
                  ...
                  className="w-24 md:w-32 h-10 rounded-3xl text-sm md:text-base bg-[#eeeeee] text-[#2C3B8D]"
                >
                  Sign in
                </button>
              </div>
          ...
          {FLAG_OTHER_EXCHANGE_FUNDING && (
            <div className="flex items-start mb-7">
              ...
              <div className="pl-4">
                ...
                {paymentMethod === 'other' && (
                  <div className="">
                    <p className="text-sm font-semibold font-inter mb-2 text-blackPrimary">
                      Enter Wallet Address
                    </p>
                    <div className="max-w-[426px] w-full">
                      <input
                        type="text"
                        className="w-full p-4 border border-[#E6E6E6] text-blackPrimary rounded-[10px] block focus:outline-none"
                      />
                    </div>
      ...
      <div className=" mt-24 fixed bottom-0 left-0 w-full bg-white ">
        <div className="bg-[#F7F7F7] h-1 w-full relative">
          <div className="duration-500 bg-blue h-full absolute left-0 top-0" />
        </div>
        <div className="container mx-auto">
          <div className="p-4 flex items-center justify-between  ">
            ...
            <div className="flex items-center justify-end gap-3">
              <button className="font-semibold  text-xs md:text-sm text-blue  py-[10px]  px-6 rounded-full">
                Back
              </button>
              <button className="font-semibold  text-xs md:text-sm">
                Next
              </button>
            </div>
          </div>
