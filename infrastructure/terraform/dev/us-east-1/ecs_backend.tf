...
resource "aws_ecs_service" "rocko_backend" {
  ...
  network_configuration {
    ...
    subnets          = [module.rocko-vpc-dev.subnet-infrastructure-private-1-id, module.rocko-vpc-dev.subnet-infrastructure-private-2-id]
...
[
  {
    ...
    "environment": [
      ...
      {"name": "ROCKO_DB_DATABASE", "value": "rocko_develop"}
    ],
    "portMappings": [
      {
        "containerPort": 5000,
