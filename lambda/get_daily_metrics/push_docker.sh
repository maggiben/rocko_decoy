...
docker tag get_daily_metrics 835780150279.dkr.ecr.us-east-1.amazonaws.com/get_daily_metrics:latest
docker push 835780150279.dkr.ecr.us-east-1.amazonaws.com/get_daily_metrics:latest
